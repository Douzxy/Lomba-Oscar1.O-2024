...
// // Contoh penggunaan
// echo AppHelper::routes('beranda'); // http://localhost/Lomba-Oscar1.O-2024/beranda
// echo AppHelper::baseImageUrl('logo.png'); // http://localhost/Lomba-Oscar1.O-2024/storage/images/logo.png
